...
<%
		...
		<a class="headerlinks"
		href="/index.jsp?page=showkeycount&search=<%=AccessionConstants.COLLECTIONCODE+AccessionConstants.SPLIT_KEY+keyid%>"><%=keyname%></a><br/>
		<%
		}
		%>
</td>
...
<%
		...
		<a class="headerlinks"
		href="/index.jsp?page=showkeycount&search=<%=AccessionConstants.STATUSCODE+AccessionConstants.SPLIT_KEY+keyid%>"><%=keyname%></a><br/>
		<%
		}
		%>
</td>
...
<%
		...
		<a class="headerlinks"
		href="/index.jsp?page=showkeycount&search=<%=AccessionConstants.COUNTRYCODE+AccessionConstants.SPLIT_KEY+keyid%>"><%=keyname%></a><br/>
		<%
		}
		%>
</td>
