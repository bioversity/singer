...
<table width="100% nowrap="nowrap">
	...
	%>
			<li id=<%=selected.equals("Y")?"navselected":"navlist"%>><a
				href="/index.jsp?page=conatoz&l=<%=alphabet%>"> <%=dispAlpha%> </a></li>
			<%
	}
	%>
		</ul>
...
<table width="100%">
	<tr>
		...
		%> <a class="headerlinks"
			href="/index.jsp?page=showkeycount&search=<%=AccessionConstants.COUNTRYCODE+AccessionConstants.SPLIT_KEY+id%>"><%=name%></a>
        <br />
		<%
		}
		%>
