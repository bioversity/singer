...
<%
	//String qType= null;
	//String qValue= null;
	String hkeycountlink = "/index.jsp?page=showkeycount&";
	String hdisppagelink = "/index.jsp?page=disppage&";
...
<%
    ...
    valuesMap = (HashMap<String, StringComparableValues>) map.get(AccessionConstants.ALL_GIS_MAP_COUNT);
			if (valuesMap != null && valuesMap.size() > 0) {
				...
				String mapLink = "/index.jsp?page=plotmap&query="+ query;
				String gmapLink = "/mapoutput.jsp?search="+ query;
%> <a class="headerlinks" href="<%=mapLink%>">View Reference Map (<%=totValues.getCount()%> accession plotted)</a>
<!-- if(stype!=null && stype.trim().equals("rangemap"))
{
%
