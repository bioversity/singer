...
<br/>
<br/>
<span class="keyTitle"><b>Collecting Missions by Institutes</b></span>
<br/>
<br/>
<%
	...
	%>
	<a class="headerlinks"
	href="/index.jsp?page=dispmissionpage&search=<%=AccessionConstants.INSTITUTECODE+AccessionConstants.SPLIT_KEY+keyid%>"><%=keyname%></a><br/>		
	<%
	}
	%>
</td>
