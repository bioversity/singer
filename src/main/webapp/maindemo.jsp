...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    ...
    <ul>
      <li type="square"><span class="BodyGray">Search for information about the samples of crop, forage, and tree germplasm <a href="/indexdemotreaty.jsp">held in trust</a> for the world</span>
    ...
    <hr/>
    <br/>
    <jsp:include page="/otherinfodemo.jsp" flush="true"/>
    <br/>
    <hr/>
    <br/>
    </td>
